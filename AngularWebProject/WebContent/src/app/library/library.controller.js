angular.module('library')
    ...
    .controller('libraryCtrl', function libraryCtrl($scope, libraryService, blockUI) {
   	...
   	$scope.searchBooks = function(){
   		...
   		var query = "";
   		var resource = libraryService.searchBook($scope.searchBookText);
   		resource.query().$promise.then(function(response) {
   			...
   			var queryForInternetArchieve = libraryService.getReadableLinksFromInternetArchieve(query);
   			queryForInternetArchieve.query().$promise.then(function(data){
   				...
   				var reviewQuery = libraryService.callReadBook();
   				reviewQuery.call(isbns_ReadableBooks).$promise.then(function(data){
   					...
   					//set the tabs
   				   $scope.tabs = [
   				               {title:'Readable', page: 'app/library/readable/readable.tpl.html'},
   				               {title:'Borrowable', page: 'app/library/borrowable/borrowable.tpl.html'},
   				             ];
